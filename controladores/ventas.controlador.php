	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				$printer -> text("   ESTAMOS UBICADOS EN Edificio Fiallo Soto\n");
				$printer -> text("AVEN. Cervantes FRENTE AL CAJERO DE BANCO LAFICE\n");
				$printer -> text("                   8785-7642\n");
				$printer -> text("          EMAIL: info@ellas-beauty.com     \n");
				$printer -> text(" \n");
				$printer -> text("          CODIGO DE FACTURA ".$_POST["nuevaVenta"]."\n");
				$printer -> text("        ATENDIDO POR: MARIA RODRIGUEZ \n");
				$printer -> feed();
			...
			if($respuesta == "ok"){
				...
				$printer -> text("         COPIA DE FACTURA Midence soto \n");
				$printer -> text("                     ".$_POST["nuevoMetodoPago"]."\n");
				$printer -> feed(1);
				$printer -> feed(1);

				$printer -> text("               Midence soto \n");
				$printer -> text(" \n");
				$printer -> text("          CODIGO DE FACTURA ".$_POST["nuevaVenta"]."\n");
				$printer -> feed();
				$printer -> text("--------------------PRODUCTOS------------------\n");
